...
const Books = ({book, handleBooking}) => {
    const {bookName, location, resalePrice, originalPrice, yearsOfUse, postTime, sellerName} = book;
          ...
          >
            ...
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                <label onClick={() => handleBooking(bookName, resalePrice)} htmlFor="booking-modal" className="btn btn-primary text-base-100">Book Now</label>
              </div>
            </div>
          </div>
    );
